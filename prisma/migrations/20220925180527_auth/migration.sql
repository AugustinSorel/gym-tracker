/*
  ...
  - You are about to drop the column `createtedAt` on the `Session` table. All the data in the column will be lost.
  ...
  - You are about to drop the column `createtedAt` on the `User` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE "Session" DROP COLUMN "createtedAt",
...
-- AlterTable
ALTER TABLE "User" DROP COLUMN "createtedAt",
